...
const PROJECTS = [
  {
    ...
    ss: '/Clarity.png',
    tech: ['React', 'JavaScript', 'Supabase', 'Html','CSS'],
    live: 'https://early-alzheimer-detection.vercel.app/',
    code: 'https://github.com/devenh29'
  },
  {
  title: '🏫 University Management System',
  desc: 'Full-stack platform for managing attendance, assignments, notifications, and user roles with secure authentication and real-time database integration using React and Supabase.',
  ss: '/University.jpg',
  tech: ['React', 'Vite', 'Supabase', 'JavaScript'],
 // live: '#',
  code: 'https://github.com/devenh29/WebDev-Portfolio'
  },
  {
    title: '♻️ Connect-E Impact — E-Waste Awareness Platform',
    desc: 'Interactive web platform built with React and Tailwind CSS that visualizes e-waste statistics through dashboards, impact graphs, and recycling insights, promoting responsible disposal and sustainability practices.',
    ss: '/Waste.jpg',
